# Generated by Django 3.2 on 2022-09-23 21:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('star_ingredient', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default=list, max_length=500), size=None)),
                ('skin_type', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default=list, max_length=200), size=None)),
                ('skin_concern', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default=list, max_length=500), size=None)),
